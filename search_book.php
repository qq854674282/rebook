    ...
    <div class="main_content">
        <div class="book_line">
            <div class="book_line_title">
                <a href="#" class="book_line_title_1 pull-left"><?php echo $book_name;?></a><!--搜索关键词或分类关键词-->
            </div>
            <div class="clearfix"></div>	
            <?php
					//分页
					$pagesize = 20;
					$sql_page = "select 1 from book where book_name like '%".$book_name."%' and status=0";
					...
					$sql = "select book_id,book_name,book_price,zone,send_type,book_image,add_time from book  where book_name like '%".$book_name."%' and status=0 order by add_time desc limit ".$pagestart.",".$pagesize;
					$rs = mysql_query($sql);
