...
$query="select book_name,book_desc,book_price,author,version,publisher,zone,send_type from book where book_id=$book_id";
        ...
        <form class="add_book" action="add_book_do.php" method="post" enctype="multipart/form-data">
        	<div class="pull-left">
              <fieldset>
                ...
                <div class="clearfix"></div>
            	<label>版本：</label>
                <input type="text" name="version" value="<?php echo $row['version']; ?>">
                <div class="clearfix"></div>
            	<label>出售价格：</label>
                <div class="input-append pull-right">
                    <input id="appendedInput" type="text" style="float:none; width:180px;" name="price" value="<?php echo $row['book_price']; ?>">
                    <span class="add-on">元</span>
                </div>
                <div class="clearfix"></div>
                <label>发布区域：</label>
                <select name="zone" id="zone">
                	<option value="东校区" <?php if($row['zone']=="东校区") echo 'selected="selected"';?>>交大东校区</option>
                    <option value="西校区 "<?php if($row['zone']=="西校区") echo 'selected="selected"';?>>交大西校区</option>
                </select>
                <div class="clearfix"></div>
                <label>物流方式：</label>
                <select name="send_type" id="send_type">
                	<option value="自己联系" <?php if($row['send_type']=="自己联系") echo 'selected="selected"';?>>自己联系</option>
                </select>
              </fieldset>
                <div class="clearfix"></div>                                      
            </div>
        	<div class="pull-left book_kind">
                ...
                <div class="clearfix"></div>                
                <fieldset id="city_c">
                    <select class="first" disabled="disabled" name="class_1" id="class_1"></select>
            ...
            <p>图片推荐尺寸：高360px，宽270px。请突出图书的封面主体。</p><br>
   		 	<script id="editor" type="text/plain" style="width:600px;height:300px;" name="book_desc"><?php echo $row['book_desc']; ?></script>  
            <br><br>
