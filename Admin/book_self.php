...
<div class="content">
    ...
    <div class="header">
        <h1 class="page-title">"自己联系"图书</h1>
    </div>
    
    <ul class="breadcrumb">
    	<li>图书管理<span class="divider">/</span></li>
        <li class="active"><a href="book_ems.php">"自己联系"图书</a><!-- <span class="divider">/</span>--></li>
    </ul>
...
<div class="row-fluid">
    <div class="block span12">
        ...
        <div id="search" class="block-body collapse in">
        	<br>
        	<form action="book_search.php" class="form-search" method="post">
...
<div class="row-fluid">
    <div class="block span12">
        <a href="#newuser" class="block-heading" data-toggle="collapse">"自己联系"图书</a>
        <div id="newuser" class="block-body collapse in">
            <table class="table">
             ...
             <?php
			  //分页
			  $pagesize = 20;
			  $sql_page = "select 1 from book where send_type='自己联系' and status=0";
			  ...
			  $query="select book_id,book_name,user_id,add_time,zone,wanted from book where send_type='自己联系' and status=0 order by book_id desc limit ".$pagestart.",".$pagesize;
