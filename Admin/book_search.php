...
<div class="row-fluid">
    <div class="block span12">
        <a href="#newuser" class="block-heading" data-toggle="collapse">图书检索</a>
        <div id="newuser" class="block-body collapse in">
            <table class="table">
              ...
              <tbody>
              <?php
			  $query="select book_id,book_name,user_id,add_time,zone,wanted,send_type from book where status=0 ";
			  if($book_name!=""){
