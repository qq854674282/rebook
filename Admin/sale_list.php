    ...
    <div class="block span12">
        ...
        <div id="newuser" class="block-body collapse in">
            <table class="table">
			  ...
			  $query="select book_id,book_name,user_id,add_time,zone,wanted,send_type from book where sale=1 and status=0 order by book_id desc limit ".$pagestart.",".$pagesize;
			  ...
			  ?>
				<tr>
                  ...
                  <td><input type="hidden" value="<?php echo $rows['book_id'];?>" class="book_id"/><a href='#' class="delete_sale">移除</a></td>
                </tr>
				<?php
				}
				?>
