    ...
    <div class="block span12">
        ...
        <div id="ad-1" class="block-body collapse in">
			<table class="table">
              ...
              <tbody>
			  <?php
			  $query="select admin_id,admin_name,login_time,password from admin where admin_type=0 and status=1";
			  ...
			  ?>
                <tr>
                  ...
                  <td>
					<a href="#" title="禁用" class="remove">解除禁用</a>
                </tr>
			  <?php
			  }
			  ?>
...
$('.remove').click(function(){
	...
	$.ajax({
	   		...
	   		type:"POST",
	   		data:{admin_id:admin_id,status:0},
	   		dataType:"json",
	   		error:function(){},
